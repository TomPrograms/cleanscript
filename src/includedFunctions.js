module.exports.in = function $_in(val, obj) {
...
module.exports.createIterable = function $_createIterable(object) {
  if (
    ...
    return object;
  } else if (Set && object.constructor === Set) return Array.from(object);

  return Object.keys(object);
};

module.exports.range = function range(start, end = 0, step = 1) {
