...
module.exports = class Parser {
  ...
  JSRAWDeclaration() {
    let code = this.consume(tokenTypes.STRING, "Expected string containing Javascript code.");
  ...
  classDeclaration() {
    ...
    if (!this.isAtEnd()) this.consume(tokenTypes.DEDENT, "Expected dedent after class.");
